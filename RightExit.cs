...
public class RightExit : AbstractRoomExit {
	...
	void OnTriggerEnter2D(Collider2D other)
	{
		if(other.tag == "Player")
		{
			...
			Vector3 NextRoomDoor = RoomsContainer.Rooms[(CurrentRoom.myI + 1),CurrentRoom.myJ].GetComponent<RoomInit>().left.transform.position;
