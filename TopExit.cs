...
public class TopExit : AbstractRoomExit {
	...
	void OnTriggerEnter2D(Collider2D other)
	{
		if(other.tag == "Player")
		{
			...
			Vector3 NextRoomDoor = RoomsContainer.Rooms[CurrentRoom.myI,(CurrentRoom.myJ+1)].GetComponent<RoomInit>().bot.transform.position;
